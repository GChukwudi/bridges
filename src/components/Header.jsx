    ...
    <header className="header">
      <nav className="nav-container">
        ...
        <ul className={`nav-links ${mobileMenuOpen ? 'active' : ''}`}>
          ...
          <li><Link to="/sme-directory" onClick={() => setMobileMenuOpen(false)}>{t.joinSME}</Link></li>
          ...
          <li><Link to="/gallery" onClick={() => setMobileMenuOpen(false)}>{t.gallery}</Link></li>
          ...
          <li><Link to="/dashboard" onClick={() => setMobileMenuOpen(false)}>{t.dashboard}</Link></li>
